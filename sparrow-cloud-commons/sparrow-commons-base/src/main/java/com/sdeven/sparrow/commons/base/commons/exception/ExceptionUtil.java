...
public abstract class ExceptionUtil {
     ...
     * Convert CheckedException to {@link RuntimeException} and re-throw it,
     * which reduces the definition of  CheckedException in the function signature.
     * <p>
     *  CheckedException will be wrapped with {@link UndeclaredThrowableException},
    ...
    /**
     * Customize a CheckedException wrapper.
     * <p>
     ...
     * <p>
     * But the Cause chain still cannot be cleared, only the StackTrace of each Cause can be cleared.
     */
