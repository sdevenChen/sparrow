...
public class MybatisCursor<T> implements Cursor<T> {
  ...
  private final com.sdeven.sparrow.commons.mybatis.plugin.MybatisResultSetHandler resultSetHandler;
  ...
  public MybatisCursor(com.sdeven.sparrow.commons.mybatis.plugin.MybatisResultSetHandler resultSetHandler, ResultMap resultMap, ResultSetWrapper rsw, RowBounds rowBounds) {
