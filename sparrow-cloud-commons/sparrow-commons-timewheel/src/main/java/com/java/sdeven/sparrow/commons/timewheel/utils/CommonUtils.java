...
import com.java.sdeven.sparrow.commons.timewheel.common.Meaningless;
import com.java.sdeven.sparrow.commons.timewheel.common.OmsConstant;
import com.java.sdeven.sparrow.commons.timewheel.common.SupplierPlus;
...
public class CommonUtils {
    ...
    public static <T> T requireNonNull(T obj, String msg) {
        if (obj == null) {
            throw new TimeWheelJobException(msg);
        }
