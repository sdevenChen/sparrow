 ...
 */
package com.sdeven.sparrow.starter.autoconfigure.dubbo.provider.valida;
...
public class ValidationFilter implements Filter {
    ...
    public Result invoke(Invoker<?> invoker, Invocation invocation) {
        ...
        if (Objects.nonNull(method)) {
            ...
            if(bean != null) {
                ...
                com.chen.sdeven.sparrow.commons.base.commons.result.Result<Object> validationResult = getValidationResult(constraintViolations);
     ...
     */
    private static <T> com.chen.sdeven.sparrow.commons.base.commons.result.Result<T> getValidationResult(Set<ConstraintViolation<T>> set) {
