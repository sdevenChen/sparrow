 ...
 */
package com.sdeven.sparrow.starter.autoconfigure.dubbo.provider;
...
import com.sdeven.sparrow.starter.autoconfigure.dubbo.exception.RpcExceptionManage;
import com.sdeven.sparrow.starter.autoconfigure.dubbo.util.LogingUtil;
    ...
    public void onResponse(Result appResponse, Invoker<?> invoker, Invocation invocation) {
        if (appResponse.hasException() && GenericService.class != invoker.getInterface()) {
            try {
                ...
                com.chen.sdeven.sparrow.commons.base.commons.result.Result response = RpcExceptionManage.exceptionResult(exception);
